...
test_strings = [
    ...
    "FILE:Tartan.txt", # FILE: is handled as a special string in unpack()
]
def unpack(text):
    # pytest -v  prints the arguments to console, messy to print entire contents of the file
...
# tests if the tokenizer can train, save and load the model file without losing functionality
